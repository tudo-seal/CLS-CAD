...
OPEN = 2.8
CLOSE = 0.98
OBJECT_POSITIONS = {'target_1': [0.051961, -0.12341, 0.27082],
                    'target_2': [-0.12341, 0.051961, 0.27082]}
...
def main():
    ...
    start_timer()
    plan_success = reach_position(arm=arm, position=[0.051961, -0.12341, 0.27082])
    stop_timer()
    success_list.append(plan_success)
    ...
    start_timer()
    plan_success = reach_position(arm=arm, position=[-0.12341, 0.051961, 0.27082])
    stop_timer()
    success_list.append(plan_success)
