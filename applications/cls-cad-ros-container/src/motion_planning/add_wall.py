...
wall_pose.header.frame_id = planning_frame
wall_pose.pose.position.x = 0.3
wall_pose.pose.position.y = 0.0
wall_pose.pose.position.z = 0.08  # small offset from ground
wall_pose.pose.orientation.w = 1.0

scene.add_box("wall", wall_pose, size=(0.02, 0.2, 0.03))  # thin wall