    ...
    for i in range(experiment_parameters["iterations"]):
        ...
        if "FAIL" in synth_with_vec_response:
            ...
            if "FAIL" in request_cheapest_response:
                ...
                # tell score to bo
                request_dict = {
                    "result": (1 - response_data['success_rate']) * experiment_parameters["score_weight"] + (lowest_cost / experiment_parameters["maximum_cost"]) * (1 - experiment_parameters["score_weight"]),
                    "synthesis_vector": synthesis_vector,
                    "experiment_id": experiment_parameters["experiment_id"],
                    "experiment_parameters": experiment_parameters
                }
