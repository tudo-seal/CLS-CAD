...
CMD_ID = f"{config.COMPANY_NAME}_{config.ADDIN_NAME}_formats_taxonomy_edit"
CMD_NAME = "Edit Taxonomy"
CMD_DESCRIPTION = 'Allows editing of the "formats" taxonomy'
PALETTE_NAME = "Taxonomy"
IS_PROMOTED = True
PALETTE_ID = "formatsTaxonomyBrowser_tax"
...
def palette_incoming(html_args: adsk.core.HTMLEventArgs):
    ...
    if message_action == "readyNotification":
        ...
        palette.sendInfoToHTML("taxonomyIDMessage", "formats")
