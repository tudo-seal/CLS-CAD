...
CMD_ID = f"{config.COMPANY_NAME}_{config.ADDIN_NAME}_parts_taxonomy_edit"
CMD_NAME = "Edit Taxonomy"
CMD_DESCRIPTION = 'Allows editing of the "parts" taxonomy'
...
def start():
    """
    Creates the promoted "Edit Taxonomy" command for the part taxonomy in the CLS-CAD
    tab.
...
def palette_incoming(html_args: adsk.core.HTMLEventArgs):
    ...
    "taxonomyDataMessage" that contains the JSON representation of the part taxonomy.
